...
namespace NLayer.Common.Helpers
{
    ...
    public class NaturalSortComparer : IComparer<string>
    {
        ...
        private readonly IDictionary<string, string[]> table = new Dictionary<string, string[]>();
        ...
        {
            if (!decimal.TryParse(left, NumberStyles.Any, CultureInfo.InvariantCulture, out var x))
            {
                return string.Compare(left, right, StringComparison.Ordinal);
            }

            if (!decimal.TryParse(right, NumberStyles.Any, CultureInfo.InvariantCulture, out var y))
            {
                return string.Compare(left, right, StringComparison.Ordinal);
            }
